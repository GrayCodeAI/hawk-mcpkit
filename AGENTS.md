...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/hawk-mcpkit/context` | Codebase overview, check index freshness |
| `gitnexus://repo/hawk-mcpkit/clusters` | All functional areas |
| `gitnexus://repo/hawk-mcpkit/processes` | All execution flows |
| `gitnexus://repo/hawk-mcpkit/process/{name}` | Step-by-step execution trace |
